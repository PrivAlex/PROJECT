        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold mb-6">Добавить Платеж</h1>
...
defineProps({
    clients: Array, // список клиентов из контроллера
    orders: Array,
});
...
const form = useForm({
    client_id: '', // ID выбранного клиента
    order_id: '', // ID выбранного клиента
    amount: '',    // Стоимость
    method: '',
